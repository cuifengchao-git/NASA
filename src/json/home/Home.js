module.exports = {
    'homeData':[
        ...
        {name: 'Chile', value: 1, relic:["复活节岛"]},  
        {name: 'China', value: 3, relic:["兵马俑","万里长城","故宫"]},  
        ...
        {name: 'Spain', value: 1, relic:["阿尔卡萨瓦城堡"]},  
        ...
        {name: 'Greece', value: 1, relic:["古希腊的帕台农神庙"]},  
        {name: 'Greenland', value: 0},  
        {name: 'Guatemala', value: 1, relic:["玛雅蒂卡尔废墟"]},  
        {name: 'French Guiana', value: 0},  
        {name: 'Guyana', value: 0},  
        {name: 'Honduras', value: 1, relic:["玛雅科潘遗址"]},  
        {name: 'Croatia', value: 0},  
        {name: 'Haiti', value: 0},  
        {name: 'Hungary', value: 0},  
        {name: 'Indonesia', value: 0},  
        {name: 'India', value: 1, relic:["印度泰姬陵"]},  
        {name: 'Ireland', value: 1, relic:["纽格莱奇墓"]},  
        {name: 'Iran', value: 0},  
        {name: 'Iraq', value: 1, relic:["古巴比伦遗址"]},  
        {name: 'Iceland', value: 0},  
        {name: 'Israel', value: 0},  
        {name: 'Italy', value: 1, relic:["罗马角斗场"]},  
        {name: 'Jamaica', value: 0},  
        {name: 'Jordan', value: 1, relic:["佩特拉古城"]},  
        {name: 'Japan', value: 0},  
        {name: 'Kazakhstan', value: 0},  
        {name: 'Kenya', value: 0},  
        {name: 'Kyrgyzstan', value: 0},  
        {name: 'Cambodia', value: 0, relic:["吴哥窟"]},  
        ...
        {name: 'Mexico', value: 1, relic:["玛雅奇琴伊察"]},  
        {name: 'Macedonia', value: 0},  
        {name: 'Mali', value: 0, relic:["廷巴克图城"]},  
        ...
        {name: 'Panama', value: 0},  
        {name: 'Peru', value: 1, relic:["印加帝国马丘比丘遗址"]},  
        {name: 'Philippines', value: 1, relic:["塔利莎城"]},  
        {name: 'Papua New Guinea', value: 0},  
        {name: 'Poland', value: 0},  
        {name: 'Puerto Rico', value: 0},  
        {name: 'North Korea', value: 0},  
        {name: 'Portugal', value: 0},  
        {name: 'Paraguay', value: 1, relic:["特立尼达耶稣会城遗址"]},  
        {name: 'Qatar', value: 0},  
        ...
        {name: 'Syria', value: 0, relic:["帕尔米拉废墟"]},  
        {name: 'Chad', value: 0},  
        {name: 'Togo', value: 0},  
        {name: 'Thailand', value: 1, relic:["大城府遗址"]},  
